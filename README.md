...
2. Versioned schemas and conformance vectors named by that manifest
3. Ratified normative specifications
4. Reference implementations
5. Examples and explanatory material

Brainstorms, pitch decks, private notes, implementation comments, and token marketing are never protocol truth.
...
The public recovery capsule may contain public protocol state, public token state, signed commitments, schemas, source, conformance vectors, and legally redistributable model artifacts. It must never contain private keys, recovery shares, API keys, raw private work, prompts, customer data, biometric/KYC material, identity mappings, or unlicensed training data.

## Licensing

Unless a file says otherwise, code and documentation are offered under Apache License 2.0. Data and model artifacts require their own explicit licenses and are not licensed merely by being referenced here.
